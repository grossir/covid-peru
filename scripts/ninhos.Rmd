...
sinadef_solo_covid <- read_delim("2022_01_30_fallecidos_sinadef.csv", delim = ";") %>% 
        mutate(
...
sinadef_solo_covid %>%
    ...
    select(-total) %>% 
    kbl(
        caption = "<b style='color:black !important; text-align:center !important;'>Criterios de clasificación en muertos por Covid del grupo de 0-4 años, 2020-2021</b>", 
    ) %>%
