...
```{r}
sinadef <- read_csv("TB_SINADEF_2021_12_23/TB_SINADEF.csv", col_types = cols(.default = col_character())) %>% 
    mutate(
...
sinadef_solo_covid <- read_delim("2021_12_31_fallecidos_covid.csv", delim = ";") %>% 
        mutate(
