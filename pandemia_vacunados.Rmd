...
con_vac %>%
    ...
    kbl(
        caption = "<b style='color:black !important; text-align:center !important;'>Distribución de pruebas positivas<br>según número de positivos por cada persona, desde 15/12/2021 hasta 24/01/2022</b>", 
    ) %>%
